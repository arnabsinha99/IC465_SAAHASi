...
def options():
    ...
    parser.add_argument(
        "-o", "--outdir", help="Output directory for image files.", required=False)
...
def main():
    ...
    # # boundary_img1 = pcv.analyze_bound_horizontal(
    # #     img=img, obj=obj, mask=mask, line_position=1680)

    # # # Determine color properties: Histograms, Color Slices, output color analyzed histogram (optional)
    # # color_histogram = pcv.analyze_color(
    # #     rgb_img=img, mask=kept_mask, hist_plot_type='all')

    # # # Pseudocolor the grayscale image
    # # pseudocolored_img = pcv.visualize.pseudocolor(
    # #     gray_img=s, mask=kept_mask, cmap='jet')
